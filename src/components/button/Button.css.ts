...
export const buttonVariants = styleVariants({
  default: [
    baseButton,
    {
      ...
      selectors: {
        "&:focus-visible": {
          outline: `2px solid ${semanticColors.gray[700]}`,
          outlineOffset: "2px",
        },
        "&:hover:not(:disabled)": {
          backgroundColor: semanticColors.gray[75],
          color: semanticColors.gray[600],
        },
        "&:active:not(:disabled)": {
          backgroundColor: semanticColors.gray[75],
          color: semanticColors.gray[600],
  ...
  gray: [
    baseButton,
    {
      backgroundColor: semanticColors.gray[700],
      color: colors.white,
      selectors: {
        "&:focus-visible": {
          outline: `2px solid ${semanticColors.gray[300]}`,
          outlineOffset: "2px",
        },
        "&:hover:not(:disabled)": {
          backgroundColor: semanticColors.gray[600],
          color: colors.white,
        },
        "&:active:not(:disabled)": {
          backgroundColor: semanticColors.gray[600],
  ...
  primary: [
    baseButton,
    {
      ...
      selectors: {
        "&:focus-visible": {
          outline: `2px solid ${semanticColors.primary[600]}`,
          outlineOffset: "2px",
        },
        "&:hover:not(:disabled)": {
